...
public class Case {
    ...
    public Case(){
        ...
        Topping topping1 = new Topping("Rainbow Sprinkles", 0.25, new ArrayList<>(Arrays.asList("none")));
        Topping topping2 = new Topping("Chocolate Syrup", 0.30, new ArrayList<>(Arrays.asList("none")));
        Topping topping3 = new Topping("Chopped Nuts", 0.40, new ArrayList<>(Arrays.asList("nuts")));
        Topping topping4 = new Topping("Crushed Oreos", 0.45, new ArrayList<>(Arrays.asList("gluten")));
        Topping topping5 = new Topping("Whipped Cream", 0.40, new ArrayList<>(Arrays.asList("dairy")));
